...
# By python version 3.7.0 (v3.7.0:1bf9cc5093, Jun 27 2018, 04:06:47) [MSC v.1914 32 bit (Intel)]
# From type library 'ScriptingSupport.8li'
# On Sun Mar 27 19:19:45 2022
'Adobe Photoshop CC 2017 Object Library'
...
class _ActionDescriptor(DispatchBaseClass):
	...
	coclass_clsid = IID('{3C1A88A6-7D1D-41CD-89BD-976AC4B32729}')
...
class _ActionList(DispatchBaseClass):
	...
	coclass_clsid = IID('{06BB2F85-A1B2-4CE4-AE78-5D85499CED5F}')
...
class _ActionReference(DispatchBaseClass):
	...
	coclass_clsid = IID('{3A203B19-7011-440E-936D-6D885F557906}')
...
class _Application(DispatchBaseClass):
	...
	coclass_clsid = IID('{D3F34469-3EEA-449D-BF3C-EFB805F4A96A}')
...
class _BMPSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{B0D91A98-3A4C-4DD2-82FC-33BBBAD921DA}')
...
class _BatchOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{22C84BB6-8B6F-4CDA-B2CD-C1310AE50331}')
...
class _BitmapConversionOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{9D29614F-2CE4-4153-BC58-995050DFDEDD}')
...
class _CMYKColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{2CCD1DC4-1933-4AAD-9A15-2B3E55EDC519}')
...
class _CameraRAWOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{075BEADF-4B26-4684-BC17-46BD4E8D8A65}')
...
class _ContactSheetOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{37534B1F-FA41-48AA-B28D-69BE98E19C1D}')
...
class _DCS1_SaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{B379D08C-1795-4485-8124-6C19CF2E2541}')
...
class _DCS2_SaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{189C9E2E-635D-4A31-B08D-F2EDB814D83A}')
...
class _DICOMOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{6ADAE091-1548-42FB-BBC2-4F9909F1B507}')
...
class _EPSOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{B667E2AA-0A00-46E6-8D5A-829288F350ED}')
...
class _EPSSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{4618E969-7D07-491A-A43E-E02CA8CB614A}')
...
class _ExportOptionsIllustrator(DispatchBaseClass):
	...
	coclass_clsid = IID('{B29BC22E-0E0B-4D85-8983-3E6714E0B750}')
...
class _ExportOptionsSaveForWeb(DispatchBaseClass):
	...
	coclass_clsid = IID('{EC62D088-5C6B-4AEB-A28D-2ED2787C5950}')
...
class _GIFSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{598D33D0-7264-476E-9282-39B64222CC10}')
...
class _GalleryBannerOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{FE089523-3276-4E69-9BD1-7D82F8A67AC8}')
...
class _GalleryCustomColorOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{7C5FDC77-2792-485E-91A1-B95039C74DD9}')
...
class _GalleryImagesOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{E14660A7-1808-46A3-B6FC-97AADFABEB93}')
...
class _GalleryOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{7A8F897A-728D-40F3-927B-6F5C89846623}')
...
class _GallerySecurityOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{BB43C659-61D0-4708-BFF6-1B2E8A7A6A4A}')
...
class _GalleryThumbnailOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{16777BB8-1F50-4CBC-9E46-E44AC5236543}')
...
class _GrayColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{2C6F99FD-04DA-4C61-9EA8-94EF4DF0892F}')
...
class _HSBColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{A0210E5C-C028-4B9C-9DF3-705F631EC881}')
...
class _IndexedConversionOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{3136566F-8588-455A-95D1-0C20BC5A1C42}')
...
class _JPEGSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{C99FE233-7FF5-42D2-8308-8BF6CC36084E}')
...
class _LabColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{21DB4940-06C6-4CC0-8A69-E90015BE9E47}')
...
class _NoColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{FFF01C3B-9081-499D-892A-FA5B0FB5BDB4}')
...
class _PDFOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{4C0DB95A-F536-4916-945C-A03EC5BEAD56}')
...
class _PDFSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{98FCACA9-FD72-4EE8-BE60-1B841A22DD9C}')
...
class _PICTFileSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{976E87F7-2955-411D-9C60-B310F3198164}')
...
class _PNGSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{40D522E9-9881-4695-85C3-4C954726F0A0}')
...
class _PathPointInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{A88454DF-0840-498A-9627-BB981088004D}')
...
class _PhotoCDOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{5C44E18F-7AD2-4B56-BB02-6E22D8010DEE}')
...
class _PhotoshopSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{D97EEA45-1682-4EBF-889C-9CCB63047B16}')
...
class _PicturePackageOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{49137025-B5F0-40D3-9A7F-DB017E186A75}')
...
class _PixarSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{9E6ABD44-E3ED-4DC0-B3EC-115C70C8FE87}')
...
class _PresentationOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{F7EEF2D5-84FF-4A97-9AD2-4D5632B149B8}')
...
class _RGBColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{7ED59994-F5B6-4CB7-AF09-27F8FA78E51C}')
...
class _RawFormatOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{C833CD93-920E-4B2E-835D-D6DB45343439}')
...
class _RawSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{CB43C0F5-0379-4A82-B01C-64632F69DB42}')
...
class _SGIRGBSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{C35D46CB-362E-4E28-99DA-35F2C5D215DF}')
...
class _SolidColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{713361B4-4ABF-4DED-9792-885C57D3DEF4}')
...
class _SubPathInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{4EE7E06A-0F99-4580-9EBB-F51CFC6AD59C}')
...
class _TargaSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{673FFDFA-3BBF-4848-AB79-7538FB9734D5}')
...
class _TiffSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{E305D5DE-F527-43E9-A994-1C5E878835DF}')
...
# This CoClass is known by the name 'Photoshop.ActionDescriptor.110'
class ActionDescriptor(CoClassBaseClass): # A CoClass
	CLSID = IID('{3C1A88A6-7D1D-41CD-89BD-976AC4B32729}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ActionDescriptor,
...
# This CoClass is known by the name 'Photoshop.ActionList.110'
class ActionList(CoClassBaseClass): # A CoClass
	CLSID = IID('{06BB2F85-A1B2-4CE4-AE78-5D85499CED5F}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ActionList,
...
# This CoClass is known by the name 'Photoshop.ActionReference.110'
class ActionReference(CoClassBaseClass): # A CoClass
	CLSID = IID('{3A203B19-7011-440E-936D-6D885F557906}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ActionReference,
...
# This CoClass is known by the name 'Photoshop.Application.110'
class Application(CoClassBaseClass): # A CoClass
	# The Adobe Photoshop application
	CLSID = IID('{D3F34469-3EEA-449D-BF3C-EFB805F4A96A}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_Application,
...
# This CoClass is known by the name 'Photoshop.BMPSaveOptions.110'
class BMPSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a BMP document
	CLSID = IID('{B0D91A98-3A4C-4DD2-82FC-33BBBAD921DA}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_BMPSaveOptions,
...
# This CoClass is known by the name 'Photoshop.BatchOptions.110'
class BatchOptions(CoClassBaseClass): # A CoClass
	# options for the Batch command
	CLSID = IID('{22C84BB6-8B6F-4CDA-B2CD-C1310AE50331}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_BatchOptions,
...
# This CoClass is known by the name 'Photoshop.BitmapConversionOptions.110'
class BitmapConversionOptions(CoClassBaseClass): # A CoClass
	# Settings related to changing the document mode to Bitmap
	CLSID = IID('{9D29614F-2CE4-4153-BC58-995050DFDEDD}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.CMYKColor.110'
class CMYKColor(CoClassBaseClass): # A CoClass
	# A CMYK color specification
	CLSID = IID('{2CCD1DC4-1933-4AAD-9A15-2B3E55EDC519}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_CMYKColor,
...
# This CoClass is known by the name 'Photoshop.CameraRAWOpenOptions.110'
class CameraRAWOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a camera RAW document
	CLSID = IID('{075BEADF-4B26-4684-BC17-46BD4E8D8A65}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.ContactSheetOptions.110'
class ContactSheetOptions(CoClassBaseClass): # A CoClass
	# Options for the Contact Sheet command
	CLSID = IID('{37534B1F-FA41-48AA-B28D-69BE98E19C1D}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.DCS1_SaveOptions.110'
class DCS1_SaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Photoshop DCS 1.0 document
	CLSID = IID('{B379D08C-1795-4485-8124-6C19CF2E2541}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_DCS1_SaveOptions,
...
# This CoClass is known by the name 'Photoshop.DCS2_SaveOptions.110'
class DCS2_SaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Photoshop DCS 2.0 document
	CLSID = IID('{189C9E2E-635D-4A31-B08D-F2EDB814D83A}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_DCS2_SaveOptions,
...
# This CoClass is known by the name 'Photoshop.DICOMOpenOptions.110'
class DICOMOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a DICOM document
	CLSID = IID('{6ADAE091-1548-42FB-BBC2-4F9909F1B507}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_DICOMOpenOptions,
...
# This CoClass is known by the name 'Photoshop.EPSOpenOptions.110'
class EPSOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a generic EPS document
	CLSID = IID('{B667E2AA-0A00-46E6-8D5A-829288F350ED}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_EPSOpenOptions,
...
# This CoClass is known by the name 'Photoshop.EPSSaveOptions.110'
class EPSSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving an EPS document
	CLSID = IID('{4618E969-7D07-491A-A43E-E02CA8CB614A}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_EPSSaveOptions,
...
# This CoClass is known by the name 'Photoshop.ExportOptionsIllustrator.110'
class ExportOptionsIllustrator(CoClassBaseClass): # A CoClass
	# Settings related to exporting Illustrator paths
	CLSID = IID('{B29BC22E-0E0B-4D85-8983-3E6714E0B750}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.ExportOptionsSaveForWeb.110'
class ExportOptionsSaveForWeb(CoClassBaseClass): # A CoClass
	# Settings related to exporting Save For Web files
	CLSID = IID('{EC62D088-5C6B-4AEB-A28D-2ED2787C5950}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GIFSaveOptions.110'
class GIFSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a GIF document
	CLSID = IID('{598D33D0-7264-476E-9282-39B64222CC10}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GIFSaveOptions,
...
# This CoClass is known by the name 'Photoshop.GalleryBannerOptions.110'
class GalleryBannerOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery banner options
	CLSID = IID('{FE089523-3276-4E69-9BD1-7D82F8A67AC8}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryCustomColorOptions.110'
class GalleryCustomColorOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery colors
	CLSID = IID('{7C5FDC77-2792-485E-91A1-B95039C74DD9}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryImagesOptions.110'
class GalleryImagesOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery images
	CLSID = IID('{E14660A7-1808-46A3-B6FC-97AADFABEB93}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryOptions.110'
class GalleryOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery command
	CLSID = IID('{7A8F897A-728D-40F3-927B-6F5C89846623}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GalleryOptions,
...
# This CoClass is known by the name 'Photoshop.GallerySecurityOptions.110'
class GallerySecurityOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery security
	CLSID = IID('{BB43C659-61D0-4708-BFF6-1B2E8A7A6A4A}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryThumbnailOptions.110'
class GalleryThumbnailOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery thumbnail creation
	CLSID = IID('{16777BB8-1F50-4CBC-9E46-E44AC5236543}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GrayColor.110'
class GrayColor(CoClassBaseClass): # A CoClass
	# A gray color specification
	CLSID = IID('{2C6F99FD-04DA-4C61-9EA8-94EF4DF0892F}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GrayColor,
...
# This CoClass is known by the name 'Photoshop.HSBColor.110'
class HSBColor(CoClassBaseClass): # A CoClass
	# An HSB color specification
	CLSID = IID('{A0210E5C-C028-4B9C-9DF3-705F631EC881}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_HSBColor,
...
# This CoClass is known by the name 'Photoshop.IndexedConversionOptions.110'
class IndexedConversionOptions(CoClassBaseClass): # A CoClass
	# Settings related to changing the document mode to Indexed
	CLSID = IID('{3136566F-8588-455A-95D1-0C20BC5A1C42}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.JPEGSaveOptions.110'
class JPEGSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a JPEG document
	CLSID = IID('{C99FE233-7FF5-42D2-8308-8BF6CC36084E}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_JPEGSaveOptions,
...
# This CoClass is known by the name 'Photoshop.LabColor.110'
class LabColor(CoClassBaseClass): # A CoClass
	# An Lab color specification
	CLSID = IID('{21DB4940-06C6-4CC0-8A69-E90015BE9E47}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_LabColor,
...
# This CoClass is known by the name 'Photoshop.NoColor.110'
class NoColor(CoClassBaseClass): # A CoClass
	# represents a missing color
	CLSID = IID('{FFF01C3B-9081-499D-892A-FA5B0FB5BDB4}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_NoColor,
...
# This CoClass is known by the name 'Photoshop.PDFOpenOptions.110'
class PDFOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a generic PDF document
	CLSID = IID('{4C0DB95A-F536-4916-945C-A03EC5BEAD56}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PDFOpenOptions,
...
# This CoClass is known by the name 'Photoshop.PDFSaveOptions.110'
class PDFSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a pdf document
	CLSID = IID('{98FCACA9-FD72-4EE8-BE60-1B841A22DD9C}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PDFSaveOptions,
...
# This CoClass is known by the name 'Photoshop.PICTFileSaveOptions.110'
class PICTFileSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a PICT document
	CLSID = IID('{976E87F7-2955-411D-9C60-B310F3198164}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.PNGSaveOptions.110'
class PNGSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a PNG document
	CLSID = IID('{40D522E9-9881-4695-85C3-4C954726F0A0}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PNGSaveOptions,
...
# This CoClass is known by the name 'Photoshop.PathPointInfo.110'
class PathPointInfo(CoClassBaseClass): # A CoClass
	# Path point information (returned by entire path dataClassProperty of path item class)
	CLSID = IID('{A88454DF-0840-498A-9627-BB981088004D}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PathPointInfo,
...
class PhotoCDOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a PhotoCD document
	CLSID = IID('{5C44E18F-7AD2-4B56-BB02-6E22D8010DEE}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PhotoCDOpenOptions,
...
# This CoClass is known by the name 'Photoshop.PhotoshopSaveOptions.110'
class PhotoshopSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Photoshop document
	CLSID = IID('{D97EEA45-1682-4EBF-889C-9CCB63047B16}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.PicturePackageOptions.110'
class PicturePackageOptions(CoClassBaseClass): # A CoClass
	# options for the Picture Package command
	CLSID = IID('{49137025-B5F0-40D3-9A7F-DB017E186A75}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.PixarSaveOptions.110'
class PixarSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Pixar document
	CLSID = IID('{9E6ABD44-E3ED-4DC0-B3EC-115C70C8FE87}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PixarSaveOptions,
...
# This CoClass is known by the name 'Photoshop.PresentationOptions.110'
class PresentationOptions(CoClassBaseClass): # A CoClass
	# options for the PDF presentation command
	CLSID = IID('{F7EEF2D5-84FF-4A97-9AD2-4D5632B149B8}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.RGBColor.110'
class RGBColor(CoClassBaseClass): # A CoClass
	# An RGB color specification
	CLSID = IID('{7ED59994-F5B6-4CB7-AF09-27F8FA78E51C}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_RGBColor,
...
# This CoClass is known by the name 'Photoshop.RawFormatOpenOptions.110'
class RawFormatOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a raw format document
	CLSID = IID('{C833CD93-920E-4B2E-835D-D6DB45343439}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.RawSaveOptions.110'
class RawSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a document in raw format
	CLSID = IID('{CB43C0F5-0379-4A82-B01C-64632F69DB42}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_RawSaveOptions,
...
# This CoClass is known by the name 'Photoshop.SGIRGBSaveOptions.110'
class SGIRGBSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a document in the SGI RGB format
	CLSID = IID('{C35D46CB-362E-4E28-99DA-35F2C5D215DF}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_SGIRGBSaveOptions,
...
# This CoClass is known by the name 'Photoshop.SolidColor.110'
class SolidColor(CoClassBaseClass): # A CoClass
	# A color value
	CLSID = IID('{713361B4-4ABF-4DED-9792-885C57D3DEF4}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_SolidColor,
...
# This CoClass is known by the name 'Photoshop.SubPathInfo.110'
class SubPathInfo(CoClassBaseClass): # A CoClass
	# Sub path information (returned by entire path dataClassProperty of path item class)
	CLSID = IID('{4EE7E06A-0F99-4580-9EBB-F51CFC6AD59C}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_SubPathInfo,
...
# This CoClass is known by the name 'Photoshop.TargaSaveOptions.110'
class TargaSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Target document
	CLSID = IID('{673FFDFA-3BBF-4848-AB79-7538FB9734D5}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_TargaSaveOptions,
...
# This CoClass is known by the name 'Photoshop.TiffSaveOptions.110'
class TiffSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a TIFF document
	CLSID = IID('{E305D5DE-F527-43E9-A994-1C5E878835DF}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_TiffSaveOptions,
...
CLSIDToClassMap = {
	...
	'{D3F34469-3EEA-449D-BF3C-EFB805F4A96A}' : Application,
	'{5C44E18F-7AD2-4B56-BB02-6E22D8010DEE}' : PhotoCDOpenOptions,
	'{C833CD93-920E-4B2E-835D-D6DB45343439}' : RawFormatOpenOptions,
	'{4C0DB95A-F536-4916-945C-A03EC5BEAD56}' : PDFOpenOptions,
	'{B667E2AA-0A00-46E6-8D5A-829288F350ED}' : EPSOpenOptions,
	'{6ADAE091-1548-42FB-BBC2-4F9909F1B507}' : DICOMOpenOptions,
	'{075BEADF-4B26-4684-BC17-46BD4E8D8A65}' : CameraRAWOpenOptions,
	'{D97EEA45-1682-4EBF-889C-9CCB63047B16}' : PhotoshopSaveOptions,
	'{B0D91A98-3A4C-4DD2-82FC-33BBBAD921DA}' : BMPSaveOptions,
	'{598D33D0-7264-476E-9282-39B64222CC10}' : GIFSaveOptions,
	'{4618E969-7D07-491A-A43E-E02CA8CB614A}' : EPSSaveOptions,
	'{C99FE233-7FF5-42D2-8308-8BF6CC36084E}' : JPEGSaveOptions,
	'{98FCACA9-FD72-4EE8-BE60-1B841A22DD9C}' : PDFSaveOptions,
	'{976E87F7-2955-411D-9C60-B310F3198164}' : PICTFileSaveOptions,
	'{9E6ABD44-E3ED-4DC0-B3EC-115C70C8FE87}' : PixarSaveOptions,
	'{40D522E9-9881-4695-85C3-4C954726F0A0}' : PNGSaveOptions,
	'{CB43C0F5-0379-4A82-B01C-64632F69DB42}' : RawSaveOptions,
	'{C35D46CB-362E-4E28-99DA-35F2C5D215DF}' : SGIRGBSaveOptions,
	'{673FFDFA-3BBF-4848-AB79-7538FB9734D5}' : TargaSaveOptions,
	'{E305D5DE-F527-43E9-A994-1C5E878835DF}' : TiffSaveOptions,
	'{B379D08C-1795-4485-8124-6C19CF2E2541}' : DCS1_SaveOptions,
	'{189C9E2E-635D-4A31-B08D-F2EDB814D83A}' : DCS2_SaveOptions,
	'{B29BC22E-0E0B-4D85-8983-3E6714E0B750}' : ExportOptionsIllustrator,
	'{EC62D088-5C6B-4AEB-A28D-2ED2787C5950}' : ExportOptionsSaveForWeb,
	'{9D29614F-2CE4-4153-BC58-995050DFDEDD}' : BitmapConversionOptions,
	'{3136566F-8588-455A-95D1-0C20BC5A1C42}' : IndexedConversionOptions,
	'{713361B4-4ABF-4DED-9792-885C57D3DEF4}' : SolidColor,
	'{2C6F99FD-04DA-4C61-9EA8-94EF4DF0892F}' : GrayColor,
	'{7ED59994-F5B6-4CB7-AF09-27F8FA78E51C}' : RGBColor,
	'{2CCD1DC4-1933-4AAD-9A15-2B3E55EDC519}' : CMYKColor,
	'{21DB4940-06C6-4CC0-8A69-E90015BE9E47}' : LabColor,
	'{A0210E5C-C028-4B9C-9DF3-705F631EC881}' : HSBColor,
	'{FFF01C3B-9081-499D-892A-FA5B0FB5BDB4}' : NoColor,
	'{F7EEF2D5-84FF-4A97-9AD2-4D5632B149B8}' : PresentationOptions,
	'{7A8F897A-728D-40F3-927B-6F5C89846623}' : GalleryOptions,
	'{FE089523-3276-4E69-9BD1-7D82F8A67AC8}' : GalleryBannerOptions,
	'{E14660A7-1808-46A3-B6FC-97AADFABEB93}' : GalleryImagesOptions,
	'{16777BB8-1F50-4CBC-9E46-E44AC5236543}' : GalleryThumbnailOptions,
	'{7C5FDC77-2792-485E-91A1-B95039C74DD9}' : GalleryCustomColorOptions,
	'{BB43C659-61D0-4708-BFF6-1B2E8A7A6A4A}' : GallerySecurityOptions,
	'{37534B1F-FA41-48AA-B28D-69BE98E19C1D}' : ContactSheetOptions,
	'{49137025-B5F0-40D3-9A7F-DB017E186A75}' : PicturePackageOptions,
	'{22C84BB6-8B6F-4CDA-B2CD-C1310AE50331}' : BatchOptions,
	'{4EE7E06A-0F99-4580-9EBB-F51CFC6AD59C}' : SubPathInfo,
	'{A88454DF-0840-498A-9627-BB981088004D}' : PathPointInfo,
	'{3C1A88A6-7D1D-41CD-89BD-976AC4B32729}' : ActionDescriptor,
	'{06BB2F85-A1B2-4CE4-AE78-5D85499CED5F}' : ActionList,
	'{3A203B19-7011-440E-936D-6D885F557906}' : ActionReference,
}
CLSIDToPackageMap = {}
